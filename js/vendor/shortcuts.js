...
(function($) {
    ...
    var special = {
        ...
        'f12': 123,
        '?': 191, // Question mark
        'minus': _ua.Blink ? [109, 45] : _ua.Gecko ? 109 : [189, 109],
        'plus': _ua.Blink ? [61, 43] : _ua.Gecko ? [61, 107] : [187, 107],
        'cmd' : _ua.Blink ? 17 : _ua.Gecko ? 224 : [91, 93]
    };
    ...
    $.Shortcuts.start = function(list) {
        ...
        $(document).bind((_ua.Blink ? 'keypress' : 'keydown') + '.shortcuts', function(e) {
